...
| 1.1 | A general description of the general-purpose AI model including: | N/A |
| 1.1.(a) | the tasks that the model is intended to perform and the type and nature of AI systems in which it can be integrated; | [Considerations: Use cases](0x24-Design-Model-Card-Considerations.md#users--use-cases)|
...
| 2 | Additional information to be provided by providers of general-purpose AI models with systemic risk | N/A |
