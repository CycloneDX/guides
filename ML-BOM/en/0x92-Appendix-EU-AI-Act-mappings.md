...
| 1.(b).(ii) |contain, at a minimum, the elements set out in Annex XII; | |
...
| Section | Text | Guide references |
| --- | --- | --- |
| 1 | Information to be provided by all providers of general-purpose AI models </br>The technical documentation referred to in Article 53(1), point (a) shall contain at least the following information as appropriate to the size and risk profile of the model: | N/A |
